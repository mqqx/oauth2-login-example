...
class DefaultAuthorizationServerConsentIT {

  @Autowired WebClient webClient;

  @MockBean OAuth2AuthorizationConsentService authorizationConsentService;
  ...
  void whenUserConsentsToAllScopesThenReturnAuthorizationCode() throws IOException {
    ...
    assertThat(location).startsWith(this.redirectUri).contains("code=");
  }
  ...
  void whenUserCancelsConsentThenReturnAccessDeniedError() throws IOException {
    ...
    assertThat(location).startsWith(this.redirectUri).contains("error=access_denied");
  }
}
